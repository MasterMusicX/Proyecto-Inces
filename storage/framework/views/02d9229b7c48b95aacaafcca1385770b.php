        ...
        <table class="w-full text-left text-sm text-gray-600 dark:text-slate-300 whitespace-nowrap">
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-slate-700/50">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/30 transition-colors">
                    ...
                    <td class="px-6 py-4 capitalize font-medium"><?php echo e($user->role); ?></td>
                    <td class="px-6 py-4">
                        <span class="px-3 py-1.5 text-[10px] font-black uppercase tracking-widest rounded-lg border <?php echo e($user->is_active ? 'bg-blue-50 dark:bg-blue-500/10 border-blue-200 dark:border-blue-800/50 text-blue-600 dark:text-blue-400' : 'bg-red-50 dark:bg-red-500/10 border-red-200 dark:border-red-800/50 text-red-600 dark:text-red-400'); ?>">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center justify-center gap-3">
                            <a href="<?php echo e(route('admin.users.edit', $user)); ?>" class="flex items-center px-4 py-2 rounded-xl bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 text-xs font-bold text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-700 hover:text-blue-600 dark:hover:text-blue-400 transition-all shadow-sm">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/inces/Escritorio/Proyecto Inces/resources/views/admin/users/index.blade.php ENDPATH**/ ?>