<?php $__env->startSection('title', 'Búsqueda Inteligente'); ?>
...
<div class="max-w-4xl mx-auto" x-data="searchPage()">
    ...
    <div x-show="results && !loading">
        ...
        <template x-if="results && results.total === 0">
            <div class="text-center py-12 card p-10">
                ...
                <p class="text-sm text-gray-400">💡 Intenta con el <a href="<?php echo e(route('student.chatbot')); ?>" class="text-brand-500 hover:underline font-medium">Asistente IA</a> para preguntas más específicas.</p>
            </div>
        </template>
    </div>
    ...
    <div x-show="!query && !results" class="text-center py-12">
        ...
        <div class="flex flex-wrap justify-center gap-3">
            <?php $__currentLoopData = ['Administración', 'Informática', 'Excel', 'Manual INCES', 'Seguridad']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $suggestion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button @click="query = '<?php echo e($suggestion); ?>'; doSearch()"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/inces/Escritorio/Proyecto Inces/resources/views/student/search.blade.php ENDPATH**/ ?>