...
<div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
        <div class="card p-5 flex items-center gap-4 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-900/10 border-purple-200 dark:border-purple-800">
            ...
            <div>
                <p class="text-3xl font-display font-bold text-purple-700 dark:text-purple-300"><?php echo e(number_format($aiStats['total_queries'])); ?></p>
        ...
        <div class="card p-5 flex items-center gap-4 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-900/10 border-blue-200 dark:border-blue-800">
            ...
            <div>
                <p class="text-3xl font-display font-bold text-blue-700 dark:text-blue-300"><?php echo e(number_format($aiStats['today_queries'])); ?></p>
        ...
        <div class="card p-5 flex items-center gap-4 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-900/10 border-green-200 dark:border-green-800">
            ...
            <div>
                <p class="text-3xl font-display font-bold text-green-700 dark:text-green-300"><?php echo e($aiStats['helpful_rate']); ?>%</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="card p-6">
            ...
            <div class="space-y-3">
                <?php $__currentLoopData = $topCourses->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div>
                    <div class="flex items-center justify-between text-sm mb-1">
                        <span class="text-gray-700 dark:text-gray-300 truncate flex-1"><?php echo e(Str::limit($course->title, 28)); ?></span>
                        <span class="font-bold text-brand-600 dark:text-brand-400 ml-2"><?php echo e($course->enrollments_count); ?></span>
                    </div>
                    <div class="h-2 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
                        <?php $maxCount = $topCourses->first()->enrollments_count ?: 1; ?>
                        <div class="h-full bg-gradient-to-r from-brand-400 to-brand-600 rounded-full"
                            style="width: <?php echo e(($course->enrollments_count / $maxCount) * 100); ?>%"></div>
                    </div>
                </div>
                    ...
                    <tr class="border-b border-gray-50 dark:border-gray-700/50 hover:bg-gray-50 dark:hover:bg-gray-700/20">
                        <td class="py-3 px-3">
                            <div class="flex items-center gap-2">
                                <img src="<?php echo e($enrollment->user->avatar_url); ?>" class="w-7 h-7 rounded-full" alt="">
                                <span class="font-medium text-gray-800 dark:text-gray-200"><?php echo e($enrollment->user->name); ?></span>
                            </div>
                        </td>
                        <td class="py-3 px-3 text-gray-600 dark:text-gray-400"><?php echo e(Str::limit($enrollment->course->title, 35)); ?></td>
                        <td class="py-3 px-3 text-gray-400 text-xs"><?php echo e($enrollment->created_at->format('d/m/Y H:i')); ?></td>
                        <td class="py-3 px-3">
                            <span class="badge <?php echo e($enrollment->status === 'completed' ? 'bg-green-100 text-green-700' : 'bg-blue-100 text-blue-700'); ?>">
                                <?php echo e($enrollment->status === 'completed' ? 'Completado' : 'Activo'); ?>
...
// Registrations chart
const regData = <?php echo json_encode($registrationsPerMonth, 15, 512) ?>;
...
// Enrollments chart
const enrData = <?php echo json_encode($enrollmentsPerMonth, 15, 512) ?>;
...
// Resource types pie
const resData = <?php echo json_encode($resourceTypes, 15, 512) ?>;
...
// User roles pie
const userData = <?php echo json_encode($userRoles, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/inces/Escritorio/Proyecto Inces/resources/views/admin/statistics.blade.php ENDPATH**/ ?>