...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 animate-fade-in-up">
    ...
    <div class="mb-8">
        <a href="<?php echo e(route('instructor.courses.show', $course)); ?>" class="inline-flex items-center text-sm font-bold text-gray-500 dark:text-slate-400 hover:text-blue-800 dark:hover:text-blue-400 transition-colors mb-3">
        ...
        <p class="text-gray-500 dark:text-slate-400 mt-1">Curso: <span class="font-bold text-blue-800 dark:text-blue-400"><?php echo e($course->title); ?></span></p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <ul class="divide-y divide-gray-100 dark:divide-slate-700/50">
                        ...
                        <li class="p-5 hover:bg-gray-50 dark:hover:bg-slate-800/30 transition-colors flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    <p class="font-bold text-gray-900 dark:text-white text-base"><?php echo e($module->title); ?></p>
                                    <?php if($module->description): ?>
                                        <p class="text-xs text-gray-500 dark:text-slate-400 mt-1 line-clamp-2"><?php echo e($module->description); ?></p>
                                    <?php endif; ?>
                            ...
                            <form method="POST" action="<?php echo e(route('instructor.courses.modules.destroy', [$course, $module])); ?>" onsubmit="return confirm('¿Estás seguro de eliminar este módulo y todos sus recursos?')">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white dark:bg-[#1e293b] rounded-3xl shadow-sm border border-gray-100 dark:border-slate-700/50 p-6 sticky top-6">
                ...
                <form method="POST" action="<?php echo e(route('instructor.courses.modules.store', $course)); ?>" class="space-y-5">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/inces/Escritorio/Proyecto Inces/resources/views/instructor/courses/modules.blade.php ENDPATH**/ ?>