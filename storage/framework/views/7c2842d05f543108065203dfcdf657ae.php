...
<body class="bg-gray-50 dark:bg-[#0b1120] text-gray-800 dark:text-slate-200 transition-colors duration-300 antialiased" x-data="{ mobileMenuOpen: false }">
    ...
    <header class="fixed w-full top-0 z-50 bg-white/90 dark:bg-[#0b1120]/90 backdrop-blur-md border-b border-gray-200 dark:border-slate-800 transition-colors">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <img src="<?php echo e(asset('images/Logo INCES.png')); ?>" alt="Logo INCES Campus" class="h-10 w-auto">
            </div>
            ...
            <nav class="hidden md:flex items-center gap-8 font-medium text-sm">
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    ?>
                    <a href="<?php echo e($dashboardRoute); ?>" class="px-6 py-2.5 bg-blue-800 hover:bg-blue-900 dark:bg-blue-600 dark:hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg shadow-blue-800/30 transition-all hover:-translate-y-0.5">
                        Ir a mi Panel
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="px-6 py-2.5 bg-blue-800 hover:bg-blue-900 dark:bg-blue-600 dark:hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg shadow-blue-800/30 transition-all hover:-translate-y-0.5">
                        Ingresar al Sistema
                    </a>
                <?php endif; ?>
            </nav>
            ...
            <div class="flex items-center gap-2 md:hidden">
                ...
                <button @click="mobileMenuOpen = !mobileMenuOpen" class="p-2.5 rounded-xl text-gray-600 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors focus:outline-none" aria-label="Abrir menú">
                ...
                <div class="pt-4 border-t border-gray-100 dark:border-slate-800">
                    <?php if(auth()->guard()->check()): ?>
                        <?php
                            $dashboardRoute = auth()->user()->role === 'admin' ? route('admin.dashboard') : (auth()->user()->role === 'instructor' ? route('instructor.dashboard') : route('student.dashboard'));
                        ?>
                        <a href="<?php echo e($dashboardRoute); ?>" class="block w-full text-center px-6 py-3 bg-blue-800 hover:bg-blue-900 dark:bg-blue-600 dark:hover:bg-blue-700 text-white font-bold rounded-xl transition-colors">
                            Ir a mi Panel
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="block w-full text-center px-6 py-3 bg-blue-800 hover:bg-blue-900 dark:bg-blue-600 dark:hover:bg-blue-700 text-white font-bold rounded-xl transition-colors">
                            Ingresar al Sistema
                        </a>
                    <?php endif; ?>
                </div>
    ...
    <section class="pt-32 pb-20 md:pt-40 md:pb-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center w-full">
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e($dashboardRoute); ?>" class="px-8 py-4 bg-red-600 hover:bg-red-700 dark:bg-red-500 dark:hover:bg-red-600 text-white font-bold rounded-xl shadow-xl shadow-red-600/30 transition-all hover:-translate-y-1 text-lg">
                    Continuar mi aprendizaje
                </a>
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="px-8 py-4 bg-red-600 hover:bg-red-700 dark:bg-red-500 dark:hover:bg-red-600 text-white font-bold rounded-xl shadow-xl shadow-red-600/30 transition-all hover:-translate-y-1 text-lg">
                    Comenzar a aprender
                </a>
            <?php endif; ?>
    ...
    <footer class="bg-blue-950 dark:bg-[#0b1120] border-t border-gray-200 dark:border-slate-800 py-12 text-center transition-colors">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <p class="text-blue-300 dark:text-slate-500 text-sm">
                &copy; <?php echo e(date('Y')); ?> Instituto Nacional de Capacitación y Educación Socialista. Todos los derechos reservados.
            </p>
        </div>
    </footer>

</body>
</html><?php /**PATH /home/inces/Escritorio/Proyecto-Inces/resources/views/welcome.blade.php ENDPATH**/ ?>