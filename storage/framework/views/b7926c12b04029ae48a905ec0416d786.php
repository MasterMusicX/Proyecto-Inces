<?php $__env->startSection('title', 'Editar Categoría: ' . $category->name); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 animate-fade-in-up">

    <div class="mb-8">
        <a href="<?php echo e(route('admin.categories.index')); ?>" class="inline-flex items-center text-sm font-bold text-gray-500 dark:text-slate-400 hover:text-blue-800 dark:hover:text-blue-400 transition-colors mb-3">
            ← Volver a Categorías
        </a>
        ...
        <p class="text-gray-500 dark:text-slate-400 mt-2">
            Actualiza el nombre, descripción y apariencia de la categoría <span class="font-bold text-blue-800 dark:text-blue-400"><?php echo e($category->name); ?></span>.
        </p>
    </div>

    <div class="bg-white dark:bg-[#1e293b] rounded-3xl shadow-sm border border-gray-100 dark:border-slate-700/50 overflow-hidden">
        
        <form action="<?php echo e(route('admin.categories.update', $category->id)); ?>" method="POST" class="p-6 sm:p-8 space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <textarea name="description" rows="4" placeholder="¿De qué trata esta área de formación?"
                          class="w-full bg-gray-50 dark:bg-[#0f172a] border border-gray-200 dark:border-slate-700 rounded-xl px-4 py-3 text-gray-900 dark:text-white outline-none focus:ring-2 focus:ring-blue-800 transition-all resize-none"><?php echo e(old('description', $category->description)); ?></textarea>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="flex items-center gap-3">
                        <input type="color" name="color" value="<?php echo e(old('color', $category->color ?? '#1e40af')); ?>" 
                ...
                <div>
                    ...
                    <input type="text" name="icon" value="<?php echo e(old('icon', $category->icon ?? '🏷️')); ?>" placeholder="Pega un emoji aquí"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/inces/Escritorio/Proyecto Inces/resources/views/admin/categories/edit.blade.php ENDPATH**/ ?>