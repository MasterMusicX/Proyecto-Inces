...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', async function(e) {
            ...
            try {
                // 3. Mandar el mensaje a tu Controlador (Revisa que esta URL sea la correcta en tus rutas)
                ...
                if (data.success) {
                    ...
                    appendMessage('error', data.error || 'Ocurrió un error en el servidor.');
                }

            } catch (error) {
                document.getElementById(typingId).remove();
                appendMessage('error', 'Error de conexión. Revisa si el servidor está corriendo.');
            }
        ...
        function appendMessage(sender, text) {
            ...
            let bubbleClass = sender === 'user'
                ...
                : sender === 'error'
                    ? 'bg-rose-50 text-rose-600 border border-rose-100 p-4 rounded-2xl rounded-tl-none shadow-sm text-sm'
            ...
            if(sender === 'error') avatar = `<div class="w-8 h-8 rounded-full bg-rose-100 flex items-center justify-center text-sm flex-shrink-0 mt-1">⚠️</div>`;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/inces/Escritorio/inces-lms/resources/views/student/chatbot.blade.php ENDPATH**/ ?>