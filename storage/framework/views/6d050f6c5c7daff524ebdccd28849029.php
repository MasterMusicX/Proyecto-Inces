...
<div class="max-w-7xl mx-auto flex flex-col gap-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 animate-fade-in-up">
        <div>
            ...
            <p class="text-sm font-medium text-gray-500 dark:text-slate-400">
                <?php echo e($courses->total() ?? 0); ?> cursos en total en la plataforma
            </p>
        </div>
        <a href="<?php echo e(route('admin.courses.create')); ?>" class="inline-flex items-center px-5 py-2.5 text-sm font-bold rounded-xl bg-blue-500 hover:bg-blue-600 text-white shadow-lg shadow-blue-500/30 transition-all hover:-translate-y-0.5 whitespace-nowrap">
    ...
    <div class="bg-white dark:bg-[#1e293b] rounded-2xl p-5 shadow-sm border border-gray-100 dark:border-slate-700/50 animate-fade-in-up" style="animation-delay: 100ms;">
        <form method="GET" class="flex flex-col md:flex-row gap-4">
            ...
            <div class="flex-1 relative">
                ...
                <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Buscar curso por nombre..." 
            ...
            <div class="md:w-48 relative">
                <select name="status" class="w-full bg-gray-50 dark:bg-[#0f172a] border border-gray-200 dark:border-transparent rounded-xl px-4 py-3 text-sm text-gray-900 dark:text-slate-200 focus:ring-2 focus:ring-blue-500 focus:border-transparent focus:outline-none transition-all appearance-none cursor-pointer">
                    ...
                    <option value="published" <?php echo e(request('status') === 'published' ? 'selected' : ''); ?>>🟢 Publicados</option>
                    <option value="draft"     <?php echo e(request('status') === 'draft'     ? 'selected' : ''); ?>>🟡 Borradores</option>
                    <option value="archived"  <?php echo e(request('status') === 'archived'  ? 'selected' : ''); ?>>🟤 Archivados</option>
                </select>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700/50 overflow-hidden flex flex-col transition-all hover:-translate-y-1 hover:shadow-md group animate-fade-in-up" style="animation-delay: <?php echo e(($i + 2) * 100); ?>ms;">
            ...
            <div class="h-40 bg-gradient-to-br from-blue-500/20 to-blue-500/20 dark:from-blue-500/10 dark:to-blue-500/10 relative overflow-hidden flex items-center justify-center border-b border-gray-100 dark:border-slate-700/50">
                <?php if($course->thumbnail): ?>
                    <img src="<?php echo e($course->thumbnail_url); ?>" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" alt="<?php echo e($course->title); ?>">
            ...
            <div class="p-5 flex-1 flex flex-col">
                ...
                <div class="flex items-center gap-2 mt-5 pt-4 border-t border-gray-100 dark:border-slate-700/50">
                    ...
                    <form method="POST" action="<?php echo e(route('admin.courses.destroy', $course)); ?>" class="m-0" onsubmit="return confirm('¿Estás seguro de que deseas eliminar este curso de forma permanente?')">
                        <?php echo csrf_field(); ?> 
        ...
        <div class="col-span-full bg-white dark:bg-[#1e293b] rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700/50 p-12 flex flex-col items-center justify-center text-center animate-fade-in-up">
            ...
            <?php if(request('search') || request('status')): ?>
                <a href="<?php echo e(route('admin.courses.index')); ?>" class="mt-4 text-blue-600 dark:text-blue-400 text-sm font-semibold hover:underline">Limpiar filtros</a>
            <?php endif; ?>
        </div>
        <?php endif; ?>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/inces/Escritorio/Proyecto Inces/resources/views/admin/courses/index.blade.php ENDPATH**/ ?>