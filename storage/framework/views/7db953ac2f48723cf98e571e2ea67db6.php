...
<div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        <div class="flex items-center gap-2 text-sm text-gray-500 mb-3">
            <a href="<?php echo e(route('admin.knowledge-base.index')); ?>" class="hover:text-blue-600 transition-colors flex items-center gap-1 font-medium">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        <form method="POST" action="<?php echo e(route('admin.knowledge-base.update', $knowledgeBase)); ?>" class="p-6 sm:p-8 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="flex items-end">
                    <label class="flex items-center gap-3 cursor-pointer p-3 border border-gray-200 dark:border-gray-600 rounded-lg w-full hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                        <input type="checkbox" name="is_active" value="1" <?php echo e($knowledgeBase->is_active ? 'checked' : ''); ?> class="w-5 h-5 text-blue-600 rounded border-gray-300 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600">
            ...
            <div>
                ...
                <input type="text" name="question" value="<?php echo e(old('question', $knowledgeBase->question)); ?>" required class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 transition-colors" placeholder="Ej: ¿Cómo me inscribo en un curso?">
            </div>
            ...
            <div>
                ...
                <textarea name="answer" rows="5" required class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 transition-colors" placeholder="Escribe la explicación detallada aquí..."><?php echo e(old('answer', $knowledgeBase->answer)); ?></textarea>
            </div>

            <div>
                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Etiquetas (Tags)</label>
                <input type="text" name="tags" value="<?php echo e(old('tags', is_array($knowledgeBase->tags) ? implode(', ', $knowledgeBase->tags) : '')); ?>" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 transition-colors" placeholder="ej: cursos, inscripcion, requisitos">
            ...
            <div class="flex items-center justify-end gap-3 pt-6 border-t border-gray-100 dark:border-gray-700">
                <a href="<?php echo e(route('admin.knowledge-base.index')); ?>" class="px-5 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:ring-4 focus:ring-gray-200 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700 transition-all">
                    Cancelar
                </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/inces/Escritorio/Proyecto-Inces/resources/views/admin/knowledge-base/edit.blade.php ENDPATH**/ ?>