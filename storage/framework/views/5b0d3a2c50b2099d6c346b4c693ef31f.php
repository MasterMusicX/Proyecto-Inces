...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 animate-fade-in-up">
    ...
    <div class="flex flex-col sm:flex-row items-center justify-between gap-4 mb-8">
        ...
        <a href="<?php echo e(route('instructor.courses.create') ?? '#'); ?>" class="px-5 py-2.5 bg-red-600 hover:bg-red-700 dark:bg-red-600 dark:hover:bg-red-700 text-white font-bold rounded-xl shadow-lg shadow-red-600/30 transition-all hover:-translate-y-0.5 flex items-center gap-2 text-sm">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white dark:bg-[#1e293b] rounded-3xl shadow-sm border border-gray-100 dark:border-slate-700/50 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group flex flex-col">
                ...
                <div class="h-36 bg-gradient-to-br from-blue-900 to-blue-600 relative overflow-hidden flex items-center justify-center">
                    ...
                    <?php if($course->thumbnail): ?>
                        <img src="<?php echo e($course->thumbnail_url); ?>" class="absolute inset-0 w-full h-full object-cover mix-blend-overlay opacity-50 transition-transform duration-500 group-hover:scale-105" alt="<?php echo e($course->title); ?>">
                    <?php else: ?>
                ...
                <div class="p-6 flex-1 flex flex-col">
                    ...
                    <div class="flex items-center gap-4 mt-auto pt-4 border-t border-gray-100 dark:border-slate-700/50">
                        <div class="flex items-center gap-1.5 text-gray-500 dark:text-slate-400" title="Estudiantes inscritos">
                            ...
                            <span class="text-sm font-bold"><?php echo e($course->enrollments_count ?? 0); ?></span>
                        </div>
                        <div class="flex items-center gap-1.5 text-gray-500 dark:text-slate-400" title="Módulos creados">
                            ...
                            <span class="text-sm font-bold"><?php echo e($course->modules_count ?? 0); ?></span>
                        </div>
                        <div class="flex items-center gap-1.5 text-gray-500 dark:text-slate-400" title="Recursos subidos">
                            ...
                            <span class="text-sm font-bold"><?php echo e($course->resources_count ?? 0); ?></span>
                        </div>
                    </div>
                </div>

                <div class="p-4 bg-gray-50 dark:bg-[#0f172a]/50 border-t border-gray-100 dark:border-slate-700/50 flex gap-3">
                    <a href="<?php echo e(route('instructor.courses.show', $course)); ?>" class="flex-1 py-2.5 text-center text-xs font-bold text-gray-700 dark:text-slate-300 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-xl hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors shadow-sm">
                        Ver Detalle
                    </a>
                    <a href="<?php echo e(route('instructor.courses.resources.index', $course)); ?>" class="flex-1 py-2.5 text-center text-xs font-bold text-white bg-blue-800 hover:bg-blue-900 dark:bg-blue-600 dark:hover:bg-blue-700 rounded-xl transition-all shadow-sm shadow-blue-800/20">
                        Recursos
                    </a>
                </div>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="col-span-full py-16 text-center bg-white dark:bg-[#1e293b] rounded-3xl border border-dashed border-gray-300 dark:border-slate-700 shadow-sm">
                ...
                <a href="<?php echo e(route('instructor.courses.create') ?? '#'); ?>" class="inline-flex px-8 py-4 bg-red-600 hover:bg-red-700 dark:bg-red-600 dark:hover:bg-red-700 text-white font-bold rounded-xl shadow-lg shadow-red-600/30 transition-all hover:-translate-y-1">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/inces/Escritorio/Proyecto-Inces/resources/views/instructor/courses/index.blade.php ENDPATH**/ ?>