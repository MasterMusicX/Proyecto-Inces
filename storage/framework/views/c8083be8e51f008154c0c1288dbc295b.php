...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 animate-fade-in-up">
        ...
        <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left">
            <div>
                <h1 class="text-3xl sm:text-4xl font-black mb-2 flex items-center justify-center md:justify-start gap-3">
                    ¡Hola de nuevo, <?php echo e(explode(' ', Auth::user()->name)[0]); ?>! <span class="text-4xl animate-wave">👋</span>
                </h1>
            ...
            <div class="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-4 text-center min-w-[120px] shadow-inner">
                <span class="block text-4xl font-black text-white"><?php echo e($enrolledCourses->count() ?? 0); ?></span>
    ...
    <div class="mb-12">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            ...
            <a href="<?php echo e(route('student.courses.catalog')); ?>" class="text-sm font-bold text-red-600 hover:text-red-700 dark:text-red-500 transition-colors bg-red-50 dark:bg-red-500/10 px-4 py-2 rounded-xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-[#1e293b] rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700/50 p-5 flex flex-col transition-all hover:shadow-lg hover:-translate-y-1">
                    <div class="flex items-start gap-4 mb-4">
                        <div class="w-16 h-16 rounded-xl bg-gray-100 overflow-hidden flex-shrink-0">
                            <img src="<?php echo e($course->thumbnail ?? 'https://images.unsplash.com/photo-1524178232363-1fb2b075b655?q=80&w=2070'); ?>" class="w-full h-full object-cover">
                        </div>
                        <div>
                            <span class="text-[10px] font-black text-red-600 uppercase tracking-widest"><?php echo e($course->category->name ?? 'General'); ?></span>
                            <h3 class="text-base font-bold text-gray-900 dark:text-white line-clamp-2 leading-tight mt-1"><?php echo e($course->title); ?></h3>
                        </div>
                    </div>
                    ...
                    <div class="mt-auto">
                        <div class="flex justify-between text-xs font-bold text-gray-500 mb-2">
                            <span>Progreso</span>
                            <span class="text-blue-600"><?php echo e($course->pivot->progress_percentage ?? 0); ?>%</span>
                        </div>
                        <div class="w-full h-2 bg-gray-100 dark:bg-slate-700 rounded-full overflow-hidden mb-4">
                            <div class="h-full bg-blue-600 rounded-full" style="width: <?php echo e($course->pivot->progress_percentage ?? 0); ?>%"></div>
                        </div>
                        <a href="<?php echo e(route('student.courses.show', $course->id)); ?>" class="block w-full py-2.5 text-center text-sm font-bold text-white bg-blue-800 hover:bg-blue-900 rounded-xl transition-colors shadow-sm">
                            Ir a clases
                        </a>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="col-span-full bg-white dark:bg-[#1e293b] rounded-3xl border border-dashed border-gray-300 dark:border-slate-700 p-10 text-center">
                    ...
                    <a href="<?php echo e(route('student.courses.catalog')); ?>" class="inline-block bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-xl font-bold shadow-lg shadow-red-600/30 transition-transform hover:-translate-y-1">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $featuredCourses ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="group bg-white dark:bg-[#1e293b] rounded-2xl overflow-hidden shadow-sm border border-gray-100 dark:border-slate-700/50 hover:shadow-lg transition-all">
                    <div class="h-32 overflow-hidden relative">
                        <img src="<?php echo e($course->thumbnail ?? 'https://images.unsplash.com/photo-1524178232363-1fb2b075b655?q=80&w=2070'); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                    </div>
                    <div class="p-4 flex flex-col">
                        <h3 class="text-sm font-bold text-gray-900 dark:text-white line-clamp-2 mb-3 group-hover:text-blue-600 transition-colors"><?php echo e($course->title); ?></h3>
                        <a href="<?php echo e(route('student.courses.show', $course->slug ?? $course->id)); ?>" class="mt-auto px-4 py-2 bg-gray-50 hover:bg-blue-800 text-gray-700 hover:text-white dark:bg-slate-800 dark:text-slate-300 rounded-lg text-xs font-bold text-center transition-colors">
                            Ver detalles
                        </a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/inces/Escritorio/Proyecto-Inces/resources/views/student/dashboard.blade.php ENDPATH**/ ?>