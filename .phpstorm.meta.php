...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/inces/Escritorio/inces-lms/public/storage' => 'string',
            ...
            'lms.name' => 'string',
            'lms.max_file_size_mb' => 'string',
            'lms.allowed_types' => 'array',
            'lms.document_types' => 'array',
            'lms.video_types' => 'array',
            'lms.image_types' => 'array',
            'lms.roles' => 'array',
            ...
            'services.gemini.max_tokens' => 'string',
            'services.gemini.temperature' => 'string',
...
'queue.failed.driver','queue.failed.database','queue.failed.table','mail.default','mail.mailers.smtp.transport',
...
'logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','concurrency.default','app.name',
...
'cors.max_age','cors.supports_credentials','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'hashing.argon.time','hashing.argon.verify','hashing.rehash_on_login','database.default','database.connections.sqlite.driver',
...
'database.redis.cache.port','database.redis.cache.database','broadcasting.default','broadcasting.connections.reverb.driver','broadcasting.connections.reverb.key',
...
'broadcasting.connections.log.driver','broadcasting.connections.null.driver','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/inces/Escritorio/inces-lms/public/storage','session.driver',
...
'view.paths','view.compiled','lms.name','lms.max_file_size_mb','lms.allowed_types',
'lms.document_types','lms.video_types','lms.image_types','lms.roles','services.postmark.token',
...
'services.slack.notifications.channel','services.gemini.api_key','services.gemini.model','services.gemini.max_tokens','services.gemini.temperature',
...
'signed','throttle','verified','role','check.active',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','login','login.post','register',
'register.post','password.request','password.email','logout','admin.dashboard',
'admin.statistics','admin.users.index','admin.users.create','admin.users.store','admin.users.show',
'admin.users.edit','admin.users.update','admin.users.destroy','admin.users.toggle','admin.courses.index',
'admin.courses.create','admin.courses.store','admin.courses.show','admin.courses.edit','admin.courses.update',
'admin.courses.destroy','admin.courses.modules.index','admin.courses.modules.store','admin.courses.modules.update','admin.courses.modules.destroy',
'admin.categories.index','admin.categories.create','admin.categories.store','admin.categories.edit','admin.categories.update',
'admin.categories.destroy','admin.knowledge-base.index','admin.knowledge-base.create','admin.knowledge-base.store','admin.knowledge-base.edit',
'admin.knowledge-base.update','admin.knowledge-base.destroy','instructor.dashboard','instructor.courses.index','instructor.courses.show',
'instructor.courses.students','instructor.courses.modules','instructor.courses.modules.store','instructor.courses.modules.destroy','instructor.courses.resources.index',
'instructor.courses.resources.create','instructor.courses.resources.store','instructor.courses.resources.destroy','student.dashboard','student.courses.catalog',
'student.courses.show','student.courses.enroll','student.courses.learn','student.resources.show','student.profile',
'student.profile.update','student.profile.password','student.chatbot','student.search',);
        registerArgumentsSet('views', 
'admin.categories.index','admin.courses.create','admin.courses.edit','admin.courses.index','admin.dashboard',
'admin.knowledge-base.create','admin.knowledge-base.edit','admin.knowledge-base.index','admin.modules.index','admin.statistics',
'admin.users.create','admin.users.edit','admin.users.index','auth.forgot-password','auth.login',
'auth.register','auth.register-success','chatbot.index','components.navbar','components.sidebar',
'components.topbar','errors.403','errors.404','instructor.courses.index','instructor.courses.modules',
'instructor.courses.show','instructor.courses.students','instructor.dashboard','instructor.resources.create','instructor.resources.index',
...
'pagination::tailwind','student.courses.catalog','student.courses.learn','student.courses.show','student.dashboard',
'student.profile','student.resources.show','student.search','vendor.pagination.bootstrap-4','vendor.pagination.bootstrap-5',
...
'APP_URL','APP_LOCALE','APP_FALLBACK_LOCALE','LOG_CHANNEL','LOG_LEVEL',
'DB_CONNECTION','DB_HOST','DB_PORT','DB_DATABASE','DB_USERNAME',
'DB_PASSWORD','SESSION_DRIVER','SESSION_LIFETIME','CACHE_STORE','QUEUE_CONNECTION',
'FILESYSTEM_DISK','MAIL_MAILER','GEMINI_API_KEY','GEMINI_MODEL','GEMINI_MAX_TOKENS',
'GEMINI_TEMPERATURE','MAX_FILE_SIZE_MB',);
