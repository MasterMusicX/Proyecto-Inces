...
// =========================================================================
// 🔥 GRUPO GLOBAL PRIVADO: ESTO EVITA QUE ENTREN POR EL HISTORIAL 🔥
// =========================================================================
Route::middleware(['auth', 'prevent-back-history'])->group(function () {
    ...
    Route::middleware(['role:admin','check.active'])->prefix('admin')->name('admin.')->group(function () {
        ...
        // 🔥 Rutas para Inscripción Forzada (Superpoder de Admin)
    ...
    Route::middleware(['role:admin,instructor','check.active'])->prefix('instructor')->name('instructor.')->group(function () {
        ...
        Route::prefix('courses/{course}')->name('courses.')->group(function () {
            ...
            Route::prefix('quizzes')->name('quizzes.')->group(function () {
                ...
                Route::post('/save',  [InstructorQuizzes::class, 'store'])->name('store'); // El parche
        ...
        // 🔥 2. EL RESOURCE BASE VA DE ÚLTIMO 🔥
