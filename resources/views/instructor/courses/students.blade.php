...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 animate-fade-in-up" 
    ...
    <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex flex-col sm:flex-row items-center gap-4">
            ...
            <a href="{{ route('instructor.courses.export-students', $course) }}" target="_blank" class="w-full sm:w-auto px-5 py-3.5 bg-red-600 hover:bg-red-700 text-white font-bold rounded-xl shadow-lg shadow-red-600/30 transition-all hover:-translate-y-0.5 flex items-center justify-center gap-2">
