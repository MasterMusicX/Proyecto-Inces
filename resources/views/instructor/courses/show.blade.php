...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 animate-fade-in-up">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-10">
        <div class="bg-white dark:bg-[#1e293b] rounded-3xl p-6 shadow-sm border border-gray-100 dark:border-slate-700/50 flex flex-col sm:flex-row items-center sm:items-start gap-4 hover:-translate-y-1 transition-transform text-center sm:text-left">
            ...
            <div>
                <p class="text-3xl font-black text-gray-900 dark:text-white">{{ $stats['students'] ?? 0 }}</p>
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-3xl p-6 shadow-sm border border-gray-100 dark:border-slate-700/50 flex flex-col sm:flex-row items-center sm:items-start gap-4 hover:-translate-y-1 transition-transform text-center sm:text-left">
            ...
            <div>
                <p class="text-3xl font-black text-gray-900 dark:text-white">{{ $stats['modules'] ?? 0 }}</p>
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-3xl p-6 shadow-sm border border-gray-100 dark:border-slate-700/50 flex flex-col sm:flex-row items-center sm:items-start gap-4 hover:-translate-y-1 transition-transform text-center sm:text-left">
            ...
            <div>
                <p class="text-3xl font-black text-gray-900 dark:text-white">{{ $stats['resources'] ?? 0 }}</p>
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-3xl p-6 shadow-sm border border-gray-100 dark:border-slate-700/50 flex flex-col sm:flex-row items-center sm:items-start gap-4 hover:-translate-y-1 transition-transform text-center sm:text-left">
            ...
            <div>
                <p class="text-3xl font-black text-gray-900 dark:text-white">{{ $stats['completed'] ?? 0 }}</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-3xl shadow-sm border border-gray-100 dark:border-slate-700/50 overflow-hidden flex flex-col">
            <div class="p-6 border-b border-gray-100 dark:border-slate-700/50 flex justify-between items-center bg-gray-50/50 dark:bg-[#0f172a]/50">
                ...
                <a href="{{ route('instructor.courses.students', $course) }}" class="text-xs font-bold text-blue-800 dark:text-blue-400 hover:text-blue-600 transition-colors bg-blue-50 dark:bg-blue-500/10 border border-blue-100 dark:border-blue-800/50 px-4 py-2 rounded-xl shadow-sm">Ver todos &rarr;</a>
            </div>
                        ...
                        <li class="p-5 hover:bg-gray-50 dark:hover:bg-slate-800/30 transition-colors flex items-center justify-between gap-4">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-slate-400">{{ $student->email }}</p>
                                </div>
                            </div>
        ...
        <div class="bg-white dark:bg-[#1e293b] rounded-3xl shadow-sm border border-gray-100 dark:border-slate-700/50 overflow-hidden flex flex-col">
            <div class="p-6 border-b border-gray-100 dark:border-slate-700/50 flex justify-between items-center bg-gray-50/50 dark:bg-[#0f172a]/50">
                ...
                <a href="{{ route('instructor.courses.modules', $course) }}" class="text-xs font-bold text-red-600 dark:text-red-400 hover:text-red-700 transition-colors bg-red-50 dark:bg-red-500/10 border border-red-100 dark:border-red-800/50 px-4 py-2 rounded-xl shadow-sm">Gestionar &rarr;</a>
            </div>
