                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors group">
                                    ...
                                    <td class="p-4 pr-6 text-right">
                                        <div class="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                            ...
                                            <form action="{{ route('admin.categories.destroy', $category->id) }}" method="POST" class="flex items-center m-0" onsubmit="return confirm('¿Seguro que deseas eliminar esta categoría? Si tiene cursos asociados, podrían quedar sin categoría.')">
                                                @csrf @method('DELETE')
                ...
                <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-5">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="icon" value="{{ old('icon', '🏷️') }}" placeholder="Ej: 💻" 
