...
<div class="max-w-7xl mx-auto p-6 md:p-8">
    ...
    <div class="flex flex-col md:flex-row items-center justify-between mb-8 gap-4">
        ...
        <a href="{{ route('admin.users.create') }}" class="bg-red-500 hover:bg-red-600 text-white font-bold py-2.5 px-6 rounded-xl flex items-center transition-all shadow-lg">
