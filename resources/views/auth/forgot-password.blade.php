...
<body class="bg-gray-50 dark:bg-[#0f172a] transition-colors duration-300 min-h-screen flex items-center justify-center p-4">
    ...
    <a href="{{ route('login') }}" class="absolute top-6 left-6 flex items-center gap-2 px-4 py-2 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-full text-sm font-medium text-gray-600 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-700 transition-all shadow-sm">
