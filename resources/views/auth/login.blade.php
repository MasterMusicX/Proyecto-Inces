...
<body class="bg-gray-50 dark:bg-[#0f172a] transition-colors duration-300 overflow-auto md:overflow-hidden min-h-screen relative flex">
    ...
    <a href="{{ url('/') }}" class="fixed top-6 left-6 z-50 flex items-center gap-2 px-4 py-2 bg-white/80 dark:bg-slate-800/80 backdrop-blur-md border border-gray-200 dark:border-slate-700 rounded-full text-sm font-medium text-gray-600 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-700 transition-all shadow-sm group">
    ...
    <div id="mainLoader" class="fixed inset-0 z-[9999] flex items-center justify-center bg-gray-50 dark:bg-[#0f172a] transition-opacity duration-500">
        <div class="relative flex items-center justify-center">
            ...
            <div class="absolute flex items-center justify-center animate-pulse-slow bg-white rounded-full p-2 shadow-lg w-16 h-16">
                <img src="{{ asset('images/Logo INCES.png') }}" class="w-full h-auto object-contain" alt="Cargando...">
            </div>
        </div>
    </div>
    ...
    @if ($errors->any() || session('success'))
        <div id="alerta" class="fixed top-4 right-4 z-50 animate-alert">
            <div class="bg-white dark:bg-slate-800 text-gray-900 dark:text-white border {{ $errors->any() ? 'border-red-500' : 'border-blue-500' }} rounded-xl shadow-2xl px-5 py-4 w-80 flex items-start space-x-3">
                <span class="{{ $errors->any() ? 'text-red-500' : 'text-blue-500' }} text-xl">
                    {{ $errors->any() ? '❌' : '✅' }}
                </span>
                <div class="flex-1">
                    <h3 class="font-bold text-sm">{{ $errors->any() ? 'Error de autenticación' : '¡Excelente!' }}</h3>
                    <p class="text-xs text-gray-500 dark:text-slate-400 mt-1">{{ $errors->any() ? $errors->first() : session('success') }}</p>
                </div>
    ...
    <div class="w-full grid grid-cols-1 md:grid-cols-2 min-h-screen">
        ...
        <div class="hidden md:flex flex-col justify-center items-center relative bg-blue-500 overflow-hidden">
            ...
            <img src="{{ asset('img/login-educacion.jpg') }}" onerror="this.src='https://images.unsplash.com/photo-1517048676732-d65bc937f952?q=80&w=2070&auto=format&fit=crop'" class="absolute inset-0 w-full h-full object-cover z-0 mix-blend-overlay opacity-50" alt="Estudiantes INCES">
            
            <div class="relative z-20 text-center px-12">
                <div class="mb-8 flex items-center justify-center">
                    <img src="{{ asset('images/Logo INCES.png') }}" alt="Logo INCES Campus" class="h-24 w-auto brightness-0 invert drop-shadow-md">
                </div>
        ...
        <div class="md:hidden h-48 relative bg-blue-950">
            ...
            <img src="{{ asset('img/login-educacion.jpg') }}" onerror="this.src='https://images.unsplash.com/photo-1517048676732-d65bc937f952?q=80&w=2070&auto=format&fit=crop'" class="absolute inset-0 w-full h-full object-cover z-0" alt="Estudiantes">
        ...
        <div class="flex flex-col justify-center items-center px-8 sm:px-12 md:px-20 py-12 bg-white dark:bg-[#0f172a]">
            ...
            <div class="w-full max-w-sm">
                <div class="text-center mb-10">
                    <img src="{{ asset('images/Logo INCES.png') }}" alt="Logo INCES" class="h-14 w-auto mx-auto mb-4 md:hidden">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" id="email" required autofocus
                                ...
                                value="{{ old('email') }}" placeholder="tu.correo@ejemplo.com">
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password" id="password" required class="w-full pl-11 pr-12 py-3 bg-gray-50 dark:bg-[#1e293b] border border-gray-200 dark:border-slate-700 rounded-xl text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-800 focus:border-transparent outline-none transition-all" placeholder="••••••••">
            
                        <button type="button" onclick="togglePassword()" class="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-400 dark:text-slate-500 hover:text-blue-800 dark:hover:text-blue-400 transition-colors">
                    ...
                    <div class="flex items-center justify-between text-sm">
                        ...
                        <a href="{{ route('password.request') }}" class="font-bold text-blue-800 dark:text-blue-400 hover:text-blue-600 transition-colors">¿Olvidaste tu contraseña?</a>
                    </div>
                ...
                <p class="mt-8 text-center text-sm text-gray-600 dark:text-slate-400">
                    ...
                    <a href="{{ route('register') }}" class="font-bold text-blue-800 dark:text-blue-400 hover:text-blue-600 transition-colors">Solicita tu acceso aquí</a>
                </p>
